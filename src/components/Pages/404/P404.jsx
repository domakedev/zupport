...
function P404() {
  return (
    <>
      <Header />
      <MainContainer>
        <ImgContainer1 src={Cloud} alt="Cloud" />
        <SecondaryContainer>
          <ImgContainer2 src={I404} alt="404" />
          <SecondaryContainerTitulo>PAGE NOT FOUND</SecondaryContainerTitulo>
          <SecondaryContainerButton href="#">VOLVER</SecondaryContainerButton>
        </SecondaryContainer>
        <ImgContainer3 src={CFail} alt="ConectionFail" />
      </MainContainer>
      <Footer />
    </>
  );
